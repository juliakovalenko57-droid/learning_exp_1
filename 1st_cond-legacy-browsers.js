...
function nameRoutineBegin(snapshot) {
  return async function () {
    ...
    nameComponents.forEach( function(thisComponent) {
...
function demogrRoutineBegin(snapshot) {
  return async function () {
    ...
    demogrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function motivationRoutineBegin(snapshot) {
  return async function () {
    ...
    motivationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Recall_PageRoutineBegin(snapshot) {
  return async function () {
    ...
    Recall_PageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Final_MetricsRoutineBegin(snapshot) {
  return async function () {
    ...
    Final_MetricsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function postoprosRoutineBegin(snapshot) {
  return async function () {
    ...
    postoprosComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NASA_TLX_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    NASA_TLX_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NASA_TLX_um_nRoutineBegin(snapshot) {
  return async function () {
    ...
    NASA_TLX_um_nComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NASA_TLX_timeRoutineBegin(snapshot) {
  return async function () {
    ...
    NASA_TLX_timeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NASA_TLX_successRoutineBegin(snapshot) {
  return async function () {
    ...
    NASA_TLX_successComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NASA_TLX_effortsRoutineBegin(snapshot) {
  return async function () {
    ...
    NASA_TLX_effortsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NASA_TLX_fruRoutineBegin(snapshot) {
  return async function () {
    ...
    NASA_TLX_fruComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
