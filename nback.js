...
let stimuli = [
  ["рыба", "kef"], ["мясо", "lim"], ["каша", "lan"],
  ["миндаль", "nax"], ["пирог", "rem"], ["блины", "lem"],
  ["вафля", "dos"], ["пряник", "mof"], ["чеснок", "zaf"], ["зефир", "bel"],
  ["халва", "dor"], ["банан", "fam"], ["укроп", "tol"],
  ["персик", "sap"], ["салат", "sal"], ["грибы", "vim"], ["багет", "rel"],
  ["морковь", "kof"], ["перец", "zix"], ["лаваш", "bik"], ["киви", "caf"],
  ["сырник", "fis"], ["манго", "fex"], ["пудинг", "los"], ["суфле", "nif"],
  ["желе", "pox"], ["кисель", "kix"], ["компот", "ras"], ["чизкейк", "sep"], ["смузи", "tef"],
  ["масло", "bef"], ["сливки", "zir"], ["творог", "bop"], ["кефир", "kaf"],
  ["йогурт", "dof"], ["ваниль", "hez"], ["арбуз", "pan"], ["рагу", "rix"], ["сало", "sof"],
  ["гуляш", "tes"], ["слива", "vem"], ["пюре", "xof"], ["попкорн", "bof"], ["шницель", "kas"],
  ["свекла", "ral"], ["дыня", "gom"], ["паста", "mis"], ["фасоль", "rex"], ["вишня", "sot"],
  ["глазурь", "hik"], ["икра", "baz"], ["сахар", "tep"], ["груша", "tos"], ["лимон", "kos"],
  ["тунец", "har"], ["горох", "ket"], ["бублик", "pem"], ["шпроты", "pos"], ["мята", "kam"],
  ["зелень", "ges"]
];
