...
let stimuli = [
  ...
  ["миндаль", "nux"], ["пирог", "rem"], ["блины", "lem"],
  ...
  ["масло", "bev"], ["сливки", "zir"], ["творог", "bup"], ["кефир", "kaf"],
  ["йогурт", "dof"], ["ваниль", "hez"], ["арбуз", "pun"], ["рагу", "rix"], ["сало", "soz"],
  ["гуляш", "tez"], ["слива", "vem"], ["пюре", "xof"], ["попкорн", "boz"], ["шницель", "cuz"],
  ["свекла", "ral"], ["дыня", "gom"], ["паста", "miz"], ["фасоль", "rex"], ["вишня", "sot"],
  ["глазурь", "hiz"], ["икра", "baz"], ["сахар", "tep"], ["груша", "tos"], ["лимон", "kos"],
